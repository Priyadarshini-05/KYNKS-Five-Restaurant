...
const Navbar = () => {
  const { navigate, user, setUser, axios, cartCount, wishlist } = useContext(AppContext);
            ...
            <div className="hidden md:block">
              {user ? (
                ...
                >
                  ...
                  {isProfileOpen && (
                    <div className="absolute right-0 mt-0 w-48 bg-white rounded-lg shadow-lg py-2 border border-gray-100 z-50">
                      <Link
                        to={"/my-bookings"}
