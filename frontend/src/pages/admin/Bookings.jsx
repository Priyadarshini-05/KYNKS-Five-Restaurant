...
const Bookings = () => {
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-1000">
      {/* Reservation Dashboard Header */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
        <div>
          <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight">Table Reservations</h2>
          <p className="text-slate-500 text-sm mt-1.5 font-medium">Coordinate seating logistics and guest capacity orchestration.</p>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse min-w-[1000px]">
            <thead>
               <tr className="bg-slate-50/30">
                <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] border-b border-slate-50">Guest Subject</th>
                <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] border-b border-slate-50">Contact Info</th>
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">ID: {item?._id.slice(-6)}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-6">
                       <p className="font-bold text-slate-900 text-[13px] tracking-tight">{item?.phone}</p>
                    </td>
                    <td className="px-8 py-6 text-center">
                      <div className="inline-flex flex-col items-center">
                         <p className="font-extrabold text-slate-900 text-lg tracking-tighter">{item?.numberOfPeople}</p>
                         <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mt-0.5">Guests</p>
                      </div>
                    </td>
                    <td className="px-8 py-6 text-center">
                ...
                <tr>
                  <td colSpan="5" className="px-8 py-32 text-center">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-slate-400 text-[11px] font-black uppercase tracking-[0.3em]">No Active Reservations Detected</p>
                    </div>
                  </td>
                </tr>
              )}
